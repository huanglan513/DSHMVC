...
public static class ListControlExtensions
{
    ...
    private static MvcHtmlString RadioButtonCheckBoxList(this HtmlHelper htmlHelper, string listName, Func<ListItem, MvcHtmlString> elementHtmlAccessor)
    {
    ...
    public static MvcHtmlString RadioButtonList(this HtmlHelper htmlHelper,string name, string listName, string value, object htmlAttributes = null)
    {
    ...
    public static MvcHtmlString DropDownList(this HtmlHelper htmlHelper, string name, string listName, string value)
    {
        ...
        foreach (var item in listItems)
        {
            selectListItems.Add(new SelectListItem { Value = item.Value, Text = item.Text, Selected = value == item.Value});
        }
